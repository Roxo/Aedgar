...
*/
 private static Vector inputAttr  = new Vector();
 
/**
* It contains a reference to all output attributes.
*/
 private static Vector outputAttr = new Vector();
 
/**
* It contains a reference to all undefined attributes.
*/
 private static Vector undefinedAttr = new Vector();
...
*/
 private static boolean hasInteger=false;
