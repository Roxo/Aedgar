...
public class SeleccionRuleta implements Seleccion{
	 ...
	 */
	    public void init(Solucion pop) {        
	  	...
	  	roul = new Ruleta (pop.getTamaño_solucion());      
	        for (i=0; i<pop.getTamaño_solucion(); i++){
	        	//Antigua , ya estaba comentada => roul.add(pop.get_regla(i).getfitness());
	        	// La que estaba cuando empecé a tocar el código => roul.add(pop.get_regla(i).getPI());
	        	
	        	// La que yo añadí (JMGM)
