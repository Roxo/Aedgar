...
public class Dataset
{
	...
	public Dataset[] getN_Sub_conjuntos_ejemplos(
		...
		int ValAleatorio = 0;
		// se considera no balanceda si el n�mero de instancias totales de la clase es un 30% de lo que corresponria si fuesen equibalanceadas
	...
	public int getTamano_conjunto_entrenamiento() {
	...
	public void Insertar_Ejemplo(Ejemplo ej) {
		...
		try {
			...
			System.out
					.println("Error a�adiendo un nuevo Cromosoma a la poblacion");
		}
	}
	 ...
	 */
	/**
	 * Devuelve la divisi�n de la clase mayoritaria entre la minoritaria. 
	 */
